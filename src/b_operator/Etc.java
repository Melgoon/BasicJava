...
public class Etc {
	...
	public static void main(String[] args) {
		 ...
		 *  
		 *  << 기타 연산자 >>
		 *  - .(참조연산자) : 특정 범위 내에 속해 있는 멤버를 지칭할 때 사용한다. // 클래스 안에 있는 변수나 메소드를 지칭할 때 사용
		 *  - (type)	: 형변환(casting)
		...
		int The = score2 > score1 ? score2 : score1;
		System.out.println("두 개의 변수 중에 큰 숫자를 출력하시오. : " + The);
		...
		System.out.println("당신의 성별은 " + gen + " 입니다."); // OR 연산자를 이용하여 작성
