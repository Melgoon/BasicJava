...
public class ComparisonOperator {
	...
	public static void main(String[] args) {
		...
		b = 10 <= 20 - 15; // 마이너스부터 계산
		System.out.println(b); // sysout 입력 후 컨트롤 스페이스바 클릭시 시스템 아웃 프린트 자동 완성
		
		//float과 double을 비교할 때는 형변환에 주의해야한다.
		b = 10.0f == 10.0; //이항연산자는 작은 쪽에서 큰쪽으로 형변환이 이루어진다. 
		System.out.println(b);
		...
		b = "abc" == new String("abc"); //new는 새로운 주소를 만드는 역할을 함
		System.out.println(b);
