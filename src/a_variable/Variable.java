...
public class Variable {
	...
	public static void main(String[] args) {
		 ...
		 * - 실수 : float(4byte), double(8byte) (소수점)
		 * - 문자 : char(2byte)
...
//		System.out.println(_byte); // 컴파일 에러 발생(문법이 틀리다.)
		...
		final int MAX_NUMBER;
		MAX_NUMBER =10;
//		MAX_NUMBER =100; 변경하여 저장할 시에 컴파일 오류 발생
...
//		System.out.println("<문자열을 출력해주세요.>");
//		String i = s.nextLine();
//		System.out.println("입력받은 문자열은 " + i +" 입니다.");
//		
...
//		System.out.println("입력받은 문자열은 " + i + " 이며, 입력받은 숫자는 " + a + " 입니다.");
...
//		System.out.println( a + b + c);
		...
		System.out.println("*아이디 : " + a +" *비밀번호 : "+ b +" *이름 : "+ c +" *전화번호 : "+ d +" *이메일 : "+ e);
