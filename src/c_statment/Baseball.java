...
//		int[] Baseball2 = {1,2,3,4,5,6,7,8,9};
//		int[] BaseBall3 = {1,2,3,4,5,6,7,8,9};
//		
//		while(true){
//			if ( Baseball != Baseball2) { //value와 value2가 같지 않으면 value3을 생성
//				
//				if (Baseball2 != BaseBall3 && Baseball != BaseBall3) { //value2랑 value3 그리고 value랑 value3이 같지 않으면 브레이크로 멈춤
//					               break;
//					            } else {
//					            	BaseBall3 = (Math.random() * 9) + 1; //랜덤함수 1~9
//					            }
//				
//					         } else { // value와 value2가 같으면 value를 새로 생성
//					        	 Baseball = (Math.random() * 9) + 1;
//					         }
//		}
